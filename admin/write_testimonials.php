...
<body>
    ...
    <main>
        ...
        ?>
        <section class="write">
                <form action="res_testimonial.php" method="post" enctype="multipart/form-data">
                    <div class="ip">
                        <div class="left__top">
                            <h2>Information</h2>
                            <p>추천인 이름</p>
                            <input type="text" name="tes_name" value="<?=$tes_name?>">
                            <p>한줄 평</p>
                            <input type="text" name="tes_oneline" value="<?=$tes_oneline?>">
                            <p>관계</p>
                            <input type="text" name="tex_real" value="<?=$tex_real?>">
                            <p>본인 사진</p>
                        ...
                        <div class="right__top">
                            <h2>Testimonial</h2>
                            <p>평가</p>
                            <textarea id="ir1" name="tes_text" ><?=$tes_text?></textarea>
                        </div>
                    </div>
